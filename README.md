...
<html lang="en">
  ...
  <body>
    <ol>
      <h4>Find the nearest grid index with given lat/lon from a pool of locations stored in a netcdf file:</h4>
      ...
      <h4>Plot time series of variables stored in netcdf files, examples:</h4>
